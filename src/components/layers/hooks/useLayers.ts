...
export const useLayers = ({
  ...
  const MVT_URLS: Record<MVTLayerId, string> = {
    perimeterNrt: `${baseUrl}/collections/public.eis_fire_lf_perimeter_nrt/tiles/{tileMatrixSetId}/{z}/{x}/{y}`,
    fireline: `${baseUrl}/collections/public.eis_fire_lf_fireline_nrt/tiles/{tileMatrixSetId}/{z}/{x}/{y}`,
    newfirepix: `${baseUrl}/collections/public.eis_fire_lf_newfirepix_nrt/tiles/{tileMatrixSetId}/{z}/{x}/{y}`,
    archivePerimeters: `${baseUrl}/collections/public.eis_fire_lf_perimeter_archive/tiles/{tileMatrixSetId}/{z}/{x}/{y}`,
    archiveFirepix: `${baseUrl}/collections/public.eis_fire_lf_newfirepix_archive/tiles/{tileMatrixSetId}/{z}/{x}/{y}`,
  };
